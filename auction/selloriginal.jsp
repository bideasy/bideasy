	...
	<div class = "blanket">
		<div id = "sell_container">
			...
			<c:if  test="${not postingAd_error_msg}">
				...
				<h2>Post an Item </h2>
				<p>Posting an item is simple and easy!</p>
				<form name = "form2" action = "${pageContext.request.contextPath}/postauction" method = "POST" >
					...
					<div class = "left_pfc">
						<label for = "reserved_price"><fmt:message key = "sell.label.reservedprice"/>  </label>
							<div class = "price_field">
								<input type = "text" id = "reserved_price" name = "reserved_price" placeholder = "Rs." required/>
							</div>
						</div>
					...
					<textarea rows = "4" cols = "25" id = "desc" name = "description" required></textarea>
					...
					<div class = "datefield_div">
						...
						<div class = "right_datefield">
							...
							<input type = "text" id = "e_datepicker" name = "end_date" style = "font-family: Verdana;" required/>
						</div>
					</div>
					...
					<div class = "catfieldchoice_div">
						...
						<span class = "catfield_choice">
							<span>
								<input type = "radio" value = "yes" name = "p_use" checked>
							</span>
							<fmt:message key = "sell.label.choiceyes"/> &nbsp;&nbsp;&nbsp;
							<span>
								<input type = "radio" value = "no" name = "p_use">
							</span>
